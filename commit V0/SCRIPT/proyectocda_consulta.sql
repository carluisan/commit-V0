...
CREATE TABLE `consulta` (
  ...
  KEY `fk_id_agendamiento` (`id_agendamiento`),
  CONSTRAINT `consulta_ibfk_1` FOREIGN KEY (`id_vehiculo_placa`) REFERENCES `vehiculo` (`id_vehiculo_placa`),
  CONSTRAINT `fk_id_agendamiento` FOREIGN KEY (`id_agendamiento`) REFERENCES `agendamiento` (`id_agendamiento`)
...
INSERT INTO `consulta` VALUES (1,'MPX163',1,'2024-05-11 09:00:00');
