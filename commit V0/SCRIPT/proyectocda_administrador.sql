...
CREATE TABLE `administrador` (
  `id_usuario_perfil` varchar(40) NOT NULL,
  ...
  CONSTRAINT `administrador_ibfk_2` FOREIGN KEY (`id_perfil`) REFERENCES `perfil` (`id_perfil`)
...
INSERT INTO `administrador` VALUES ('8003014980030149A','80030149','80030149A');
