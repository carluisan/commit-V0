...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "UPDATE usuarios2 SET id_perfil='$id_perfil', id_usuario='$id_usuario', usuario='$usuario', perfil='$perfil', contraseña='$contraseña' WHERE id_perfil='$old_id_perfil'";
    ...
    $sql = "SELECT * FROM usuarios2 WHERE id_perfil='$id_perfil'";
